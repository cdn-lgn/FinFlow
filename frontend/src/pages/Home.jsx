...
export default function Home() {
  ...
  const faqs = [
    {
      ...
      answer:
        "You'll need your PAN card for verification, and you'll complete face verification during registration. We'll also need basic KYC details like address proof.",
    },
    {
      question: "How does verification work?",
      answer:
        "We offer two verification methods: 1) Instant verification through PAN card matching 2) Manual verification by our banking team within 24 hours.",
    },
    {
      question: "How do I set up my Transaction PIN?",
      answer:
        "After account verification, you can set your 4-digit transaction PIN from the dashboard's security settings. This PIN will be required for all transactions.",
    },
    {
      question: "What are the transaction limits?",
      answer:
        "Verified accounts have no daily transaction limits. All transactions require PIN verification for security.",
    },
    {
      question: "Can I request money from other users?",
      answer:
        "Yes, you can send money requests to other FinFlow users. They can accept or reject these requests through their dashboard.",
    },
  ];

  const sectionStyle =
    "min-h-screen w-full snap-start flex items-center justify-center px-4";
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <section
        className="min-h-screen w-full snap-center snap-mandatory flex items-center justify-center relative"
        ...
        <div className="max-w-6xl w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            {steps.map((step, index) => (
              ...
              >
                <div className="mb-4 text-3xl text-blue-600 flex justify-center">
                  {step.icon}
                </div>
      ...
      <section className={`${sectionStyle} snap-center snap-mandatory`}>
        <div className="max-w-3xl w-full">
          ...
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="mb-4  px-4 py-2 border rounded-md flex flex-col overflow-hidden"
      ...
      >
        <p className="text-sm">
          &copy; {new Date().getFullYear()} <b>FinFlow</b> — Modern Banking,
          Made for You.
        </p>
        <div className="flex justify-center gap-6 mt-4 text-2xl">
          <a
            href="https://instagram.com/cdn_lgn"
            target="_blank"
            rel="noreferrer"
          >
            <FaInstagram
